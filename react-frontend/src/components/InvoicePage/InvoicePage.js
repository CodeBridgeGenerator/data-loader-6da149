...
const InvoicePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoice")
            .find({ query: { $limit: 10000 , invoicetype : urlParams.singleEinvoiceTypesId ,supplierSidentifiertype : urlParams.singleIdentifyTypeId ,thefirstsupplierScontactnumber : urlParams.singlePhoneNumberPrefixId ,suppliercountryname : urlParams.singleCountryCodeId ,supplierstatename : urlParams.singleStateCodeId ,buyeridentifiertype : urlParams.singleIdentifyTypeId ,buyerSaddressCountryname : urlParams.singleCountryCodeId ,buyerSaddressStatename : urlParams.singleStateCodeId ,thefirstbuyerScontactnumber : urlParams.singlePhoneNumberPrefixId ,paymentinformationfrequencyofbilling : urlParams.singleFrequencyOfBillingId ,paymentinformationpaymentmode : urlParams.singlePaymentModeId ,shippingrecipientSaddresscountryname : urlParams.singleCurrencyCodeId ,shippingrecipientSaddressstatename : urlParams.singleStateCodeId ,shippingrecipientSidentifiertype : urlParams.singleIdentifyTypeId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
